...
#define Feature_EXTRAS                               \
    virtual void dump_with_types(ostream&, int) = 0; \
    virtual void FeatureTypeCheck(TypeCheckEnvironment& env) = 0;

#define Feature_SHARED_EXTRAS            \
    void dump_with_types(ostream&, int); \
    void FeatureTypeCheck(TypeCheckEnvironment& env);
...
#define Expression_EXTRAS                            \
    ...
    virtual Symbol ExpTypeCheck(TypeCheckEnvironment& env) = 0;

#define Expression_SHARED_EXTRAS         \
    void dump_with_types(ostream&, int); \
    Symbol ExpTypeCheck(TypeCheckEnvironment& env);
